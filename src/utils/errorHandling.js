...
export function showNotification(message, type) {
    ...
    notification.className = `fixed top-6 right-6 px-6 py-3 rounded-xl shadow-2xl z-[9999] text-base font-semibold transition-all duration-300 ${type === 'success' ? 'bg-green-500/80 text-white' :
...
export async function safeAsync(asyncFn, errorHandler) {
    try {
