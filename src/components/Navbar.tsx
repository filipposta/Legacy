...
function Navbar() {
  ...
  const [stableAuthState, setStableAuthState] = useState<boolean>(() => {
        ...
        unsubscribe = auth.onAuthStateChanged(async (currentUser) => {
          ...
          if (currentUser) {
            ...
            try {
              ...
              const loadUserProfile = async (retries = 2): Promise<any> => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <img src="/logo.png" alt="ScySocial" className="h-16 w-auto" />
          </div>
          <div className="flex items-center">
  ...
  return (
    <nav className="bg-white/10 backdrop-blur-lg border-b border-white/20 sticky top-0 z-50">
      ...
      {connectionError && (
        <div className="bg-yellow-500/20 border-b border-yellow-500/30 px-4 py-1">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          {/* Logo/Brand */}
          <div className="flex items-center">
            <Link to="/posts" className="hover:text-cyan-400 transition-colors">
              <img src="/logo.png" alt="ScySocial" className="h-16 w-auto" />
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* Sign Out Button - Using the enhanced quick logout only */}
              <button
              ...
              <div className="border-t border-white/20 pt-3">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 flex items-center space-x-3 text-red-400 hover:text-red-300 hover:bg-red-500/10 px-3 py-3 rounded-md text-base font-medium transition-colors"
                  >
